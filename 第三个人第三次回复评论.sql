190414 16:25:46	417 Connect	root@localhost on phpcmsv9
...
418 Connect	root@localhost on phpcmsv9

SET character_set_connection='utf8',character_set_results='utf8',character_set_client=binary, sql_mode=''

REPLACE INTO `phpcmsv9`.`v9_session`(`sessionid`,`userid`,`ip`,`lastvisit`,`roleid`,`groupid`,`m`,`c`,`a`,`data`) VALUES ('ccq8cu7fck8u0qf812b2r55pa4','1','127.0.0.1','1555230346','1','0','admin','index','public_session_life','code|s:0:"";userid|s:1:"1";roleid|s:1:"1";pc_hash|s:6:"3VT5Pd";lock_screen|i:0;')

DELETE FROM `phpcmsv9`.`v9_session` WHERE `lastvisit`<1555228546

190414 16:26:18	419 Connect	root@localhost on phpcmsv9
...
SELECT * FROM `phpcmsv9`.`v9_comment_data_1` WHERE `id` = '3' LIMIT 1
...
毛主席的诗歌，肯定好啊，不用说','','content_6-1-1','1','127.0.0.1','1','1555230378','1')
UPDATE `phpcmsv9`.`v9_comment_table` SET `total`=`total`+1 WHERE `tableid` = '1'

UPDATE `phpcmsv9`.`v9_comment` SET `lastupdate`='1555230378',`total`=`total`+1 WHERE `commentid` = 'content_6-1-1'

190414 16:26:19	420 Connect	root@localhost on phpcmsv9
