190414 17:23:10	522 Connect	root@localhost on phpcmsv9
...
SELECT `tableid`,`total` FROM `phpcmsv9`.`v9_comment_table` ORDER BY tableid desc LIMIT 1

INSERT INTO `phpcmsv9`.`v9_comment`(`commentid`,`siteid`,`tableid`,`display_type`,`title`,`url`) VALUES ('content_6-2-1','1','1','1','phpcms 第二篇文章','http://phpcms.io/index.php?m=content&c=index&a=show&catid=6&id=2')

SHOW TABLES

SELECT * FROM `phpcmsv9`.`v9_comment_setting` WHERE `siteid` = '1' LIMIT 1

INSERT INTO `phpcmsv9`.`v9_comment_data_1`(`userid`,`username`,`content`,`direction`,`commentid`,`siteid`,`ip`,`status`,`creat_at`) VALUES ('3','member2','评论第二篇文章','3','content_6-2-1','1','127.0.0.1','1','1555233790')

UPDATE `phpcmsv9`.`v9_comment_table` SET `total`=`total`+1 WHERE `tableid` = '1'

UPDATE `phpcmsv9`.`v9_comment` SET `lastupdate`='1555233790',`total`=`total`+1,`neutral`=`neutral`+1 WHERE `commentid` = 'content_6-2-1'

190414 17:23:11	523 Connect	root@localhost on phpcmsv9
