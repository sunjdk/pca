...
SELECT * FROM `phpcmsv9`.`v9_comment_data_1` WHERE `id` = '7' LIMIT 1
...
member2 于 2019-04-14 16:40:59发布member2也来回复，毛泽东的诗歌就是不凡
老铁没毛病，666。毛主席的诗歌，谁敢说不好？','','content_6-1-1','1','127.0.0.1','1','1555232241','1')
UPDATE `phpcmsv9`.`v9_comment_table` SET `total`=`total`+1 WHERE `tableid` = '1'

UPDATE `phpcmsv9`.`v9_comment` SET `lastupdate`='1555232241',`total`=`total`+1 WHERE `commentid` = 'content_6-1-1'

190414 16:57:22	490 Connect	root@localhost on phpcmsv9
